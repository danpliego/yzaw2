            ...
            <header className="space-y-4">
              ...
              <div className="space-y-4 text-[#37372f] max-w-2xl mx-auto lg:max-w-3xl">
                <p className="font-['Arsenal'] text-xl mb-0">
                  Each year, our design and editorial teams come together to
                  honor the products that transform yards into truly livable
                  spaces. The 2025 Yardzen Awards feature a combination of
                  Designer Picks—our most-used products across real client
                  projects—and Also Great picks—standouts selected for
                  innovation, design appeal, and sustainability.
                </p>
              </div>
            </header>
