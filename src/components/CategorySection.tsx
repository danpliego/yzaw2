...
import SecondaryProductCard, {
  type SecondaryProduct,
} from "./SecondaryProductCard";
                  ...
                  {authors.map(
                    (author, index) =>
                      author.description && (
                        <>
                          <p
                            key={`${author.name}-desc-${index}`}
                            className="text-base leading-[1.4] font-light m-0"
                          >
                            {author.description}
                          </p>{" "}
                          <a
                            href="https://yardzen.com/packages"
                            className="underline"
                          >
                            Explore Design Plans →
                          </a>
                        </>
                      )
                  )}
