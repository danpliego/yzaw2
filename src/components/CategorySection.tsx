      ...
      <div className="px-4 md:px-8 py-8 md:py-[60px] max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-12 items-start w-full mb-8 md:mb-10">
          ...
          <div className="flex flex-col gap-2 items-start justify-start">
            <h1 className="font-['Arsenal'] text-2xl md:text-[40px] text-[#3b482f] leading-[1.2] font-normal m-0">
              {title}
            </h1>
          </div>
          ...
          <div className="flex flex-col gap-4 md:gap-6 items-start justify-start">
            <p className="text-base md:text-lg text-[#37372f] leading-[1.4] tracking-[0.18px] font-normal m-0">
              {description}
            </p>
            ...
            <div className="bg-white border border-[rgba(0,0,0,0.1)] rounded-lg overflow-hidden w-full">
              <div className="flex flex-row gap-4 items-start justify-start p-4">
                ...
                <div className="flex flex-col gap-2 items-start justify-start text-[#37372f] text-left w-full">
                  ...
                  {authors.map((author, index) => (
                    author.description && (
                      <p key={`${author.name}-desc-${index}`} className="text-base leading-[1.4] font-normal m-0">
                        {author.description}
                      </p>
                    )
                  ))}
        ...
        <div className="flex flex-col gap-4 items-start justify-start w-full mb-0">
          {/* Section Header */}
          <div className="flex flex-row items-center justify-between border-t border-[rgba(98,110,88,0.25)] pt-4 w-full">
            <div className="bg-[#ecf4bf] flex flex-row gap-2 items-center justify-center px-3 py-1.5 rounded-full">
              <span className="font-['Arsenal'] text-[#37372f] text-base md:text-lg tracking-[0.22px] font-medium">
                {primarySectionTitle}
              </span>
            </div>
          </div>
        ...
        <div className="flex flex-col gap-4 items-start justify-start w-full">
          {/* Section Header */}
          <div className="flex flex-row items-start justify-center border-t border-[rgba(98,110,88,0.25)] pt-4 mt-6 w-full">
            <h2 className="font-['Arsenal'] text-xl md:text-[32px] text-[#3b482f] leading-[1.2] font-medium m-0">
              {secondarySectionTitle}
            </h2>
          </div>
